 ...
 *
 * Uses reflective access to the private vault key until the member method lands
 * in a full-file CryptoSecurityManager commit. Returns null when the user-auth
 * validity window is closed (UserNotAuthenticatedException).
 */
