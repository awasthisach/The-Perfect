...
class SemanticSearchUseCaseTest {
    ...
    @Test
    fun emptyQueryReturnsEmpty() = runBlocking {
        val useCase = SemanticSearchUseCase(FakeSemantic(), FakeSearchRepo(), FakeFileManager())
        val results = useCase.searchSemantically("")
